...
////////////// creates calendar objects with text entries for each date //////////////
...
// creates two rectangle objects from the min/mean/max array and pushes into array of arrays
...
/////////// creates min/max rectangle objects within each <g> /////////////////
...
function make_axes(dataset){
  ...
  function formatTemperature(d) {
    ...
    return d === y.domain()[1] ?  s + " degrees" : s;
  }
